...
class RegistrationVC: UIViewController , UITextFieldDelegate, UIScrollViewDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBOutlet var lbIntroduceCode: UILabel!
     @IBOutlet var textIntroduceCode: UITextField!
...
//    var datePickerToolBar     = UIToolbar()
    ...
    override func viewDidLoad() {
        ...
        setLabelLanguageData(label: registrationMesageLab, key: "Setup, only takes a moment, you'll be booking appointments in no time.")
        ...
        textIntroduceCode.placeholder = setMessage(key: "IntroducerCode")
               lbIntroduceCode.text = setMessage(key: "IntroducerCode")
...
//        createDatePickerToolBar()
    ...
    @IBAction func registerTapped(_ sender: Any) {
        ...
        setMessageLanguageData(&enterYourBusinessPhone, key: "Business phone")
...
//            }
            if (phoneText.text == "") || ((phoneText.text?.isEmpty)!) {
                displayAlertMsg(userMsg: enterYourBusinessPhone)
            }
//            if (birthdayText.text == "") || ((birthdayText.text?.isEmpty)!) {
...
//            }
            ...
            bussinessPhone = phoneText.text
            adminDesc = DescriptionText.text ?? "No Description"
...
//                    if self.errorList["birthdate"] as? [String] != nil {
//                        self.errorMessage = self.errorList["birthdate"] as? [String]
//                        self.displayAlertMsg(userMsg: self.errorMessage?[0] ?? "The birthdate is not a valid date")
//                    }
...
//***************************** Hide KeyBoard ***********************************
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        ...
        case 1:
            registerScrollView.setContentOffset(CGPoint(x: 0, y: 60), animated: true)
        case 2:
            registerScrollView.setContentOffset(CGPoint(x: 0, y: 100), animated: true)
        case 3:
            registerScrollView.setContentOffset(CGPoint(x: 0, y: 140), animated: true)
        case 4:
            registerScrollView.setContentOffset(CGPoint(x: 0, y: 180), animated: true)
        case 5:
            registerScrollView.setContentOffset(CGPoint(x: 0, y: 220), animated: true)
        default:
            print("ok")
        }
    }
    ...
    func saveProfile() {
        ...
        let gender   = "&gender=\(adminGender ?? 1)"
...
var enterYourBusinessPhone = String()
