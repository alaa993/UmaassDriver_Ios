...
class ContactUsVC: UIViewController, MFMailComposeViewControllerDelegate {
    ...
    @IBOutlet weak var adresLab: UILabel!
    ...
    override func viewDidLoad() {
        ...
        setLabelLanguageData(label: adresLab, key: "umaassAddress")
...
//                self.versionLabel.text = "Version  " + "\(self.appVersion)"
//            }else{
//
//            }
//        }
...
//
    ...
    @IBAction func messageToWhatsappTapped(_ sender: Any) {
        ...
        //        let url:NSURL = URL(string: ("TEL://+447732830221"))! as NSURL
        //        UIApplication.shared.open(url as URL)
        //        let whatsappUrl = ""
        //        let whatsapp = URL(string: "WhatsApp://app")!
        //        if UIApplication.shared.canOpenURL(whatsapp) {
        //            UIApplication.shared.open(whatsapp, options: convertToUIApplicationOpenExternalURLOptionsKeyDictionary(["":""]), completionHandler: nil)
        //        } else {
        //            UIApplication.shared.open(URL(string: whatsappUrl)! as URL, options: convertToUIApplicationOpenExternalURLOptionsKeyDictionary([:]), completionHandler: nil)
        //        }
    }
